...
public class VerifyTheEmailTask extends BaseClassSp19{
	
@Test	
public void runVerifyTheEmailTask() throws InterruptedException, IOException {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@name='Company']"))).sendKeys("Testleaf");
