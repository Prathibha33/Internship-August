...
//
//Fill in all the mandatory fields (Account Name, Type) with valid data.
//
//Click on the Save button.
//
//In the newly created Account page, locate the 'Contacts' related list and click on the 'NewContact' button.
//
//Fill in all the mandatory fields (First Name, Last Name, Email) with valid data.
//
//Click on the 'Save' button.
//
//Go back to the detailed view of the created Account.
//
...
//
//Search for the deleted contact by First Name, Last Name, or Email.
...
public class CreateAAccountAndContactsInAccounts {
public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("//input[@id='password']")).sendKeys("Java@223");
		...
		//Enter salutation
		WebElement dd = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[text()='--None--']")));
		...
		//Go to accounts tab
		WebElement accountstab = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//a[@class='slds-context-bar__label-action dndItem'])[9]")));
