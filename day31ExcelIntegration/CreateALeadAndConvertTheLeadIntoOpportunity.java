...
public class CreateALeadAndConvertTheLeadIntoOpportunity extends BaseClassDay31 {
	
	@BeforeTest
	public void setFile() {
		fileName="CreateALeadAndConvertTheLeadIntoOpportunity";
	}
@Test(dataProvider = "fetchData")	
public void runCreateALeadAndConvertTheLeadIntoOpportunity(String firstName, String lastName, String companyName ) throws InterruptedException, IOException {
		...
		search.sendKeys(firstName,Keys.ENTER);
		...
		WebElement opname1 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//span[@data-aura-class='forceInlineEditCell']")));
		driver.executeScript("arguments[0].click();", opname1);
		
		
		//Take a snap of the web page
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//span[@data-aura-class='forceInlineEditCell'])[2]")));
