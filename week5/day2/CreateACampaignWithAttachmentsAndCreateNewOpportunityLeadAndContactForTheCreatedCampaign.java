...
public class CreateACampaignWithAttachmentsAndCreateNewOpportunityLeadAndContactForTheCreatedCampaign {
public static void main(String[] args) throws InterruptedException, IOException {
		...
		//Click on add leads near campaign members
		WebElement addContacts = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[@title='Add Contacts']")));
